  ...
  return (
    <section className="login-screen" aria-labelledby="login-title">
      <div className="login-panel">
        <div className="login-panel__header login-panel__header--horizontal">
          <img
            className="login-panel__coat login-panel__coat--horizontal"
            src={brasaoPrefeitura}
            alt="Brasão da Prefeitura"
          />

          <div className="login-panel__titles">
